...
from smash_core.query import (
    query_smash as _core_query_smash,
)
...
from smash_core.mcp_verify import (
    set_smash_command_override as _core_set_smash_command_override,
)
...
from smash_core.status import (
    smash_status as _core_smash_status,
)
...
def _api_discovery_payload() -> dict[str, object]:
    return {
        "api_version": API_VERSION,
        "name": "Smash local HTTP API",
        "description": "Loopback-only API for Smash local agent memory.",
        "local_only": True,
        "recommended": {
            "readiness": "/api/health",
            "agent_context": "/api/query-Smash?q=<query>&budget=small",
        ...
        "write_header": {"X-Smash-Local-Action": "true"},
    }
