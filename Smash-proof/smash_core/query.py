"""Smart query packet construction for Smash agents.
...
def _hybrid_ranked_items(
    ...
    for index, page in enumerate(pages):
        ...
        if relationship == "primary":
            ...
            score += 14
            signals.append(f"{relationship}-Smash")
...
def query_link(
    ...
    *,
    ...
    guidance = [
        ...
        "Use provenance.path/source/date fields to explain why Smash knows something.",
