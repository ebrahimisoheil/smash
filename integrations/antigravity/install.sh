#!/bin/bash
# Smash integration for Google Antigravity (Gemini CLI)
# One command: GEMINI.md + wiki scaffold + smash-mcp install
#
# Usage:
#   bash install.sh             → global: ~/.gemini/GEMINI.md + central wiki at ~/Smash/
