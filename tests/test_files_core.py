...
from smash_core.files import append_text, append_text_with_rotation, atomic_write_json, atomic_write_text  # noqa: E402


class FilesCoreTests(unittest.TestCase):
    def test_atomic_write_text_replaces_existing_file(self):
        root = Path(tempfile.mkdtemp(prefix="Smash-files-core-"))
