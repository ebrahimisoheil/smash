...
from smash_core.web_layout import render_footer_html, render_header_html, render_layout, render_stat_grid  # noqa: E402
...
class WebLayoutCoreTests(unittest.TestCase):
    def test_header_has_primary_navigation_and_search(self):
        ...
        self.assertIn('aria-label="Search Smash"', html)
