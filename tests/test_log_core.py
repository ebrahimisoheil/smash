...
from smash_core.log import DEFAULT_LOG_TEXT, append_log, read_log_entries, verify_log_integrity  # noqa: E402


class LogCoreTests(unittest.TestCase):
    def test_append_log_rotates_unbounded_operation_log(self):
        root = Path(tempfile.mkdtemp(prefix="Smash-log-core-"))
        wiki_dir = root / "wiki"
        ...
        self.assertIn("- Memory: testing Smash", current)
