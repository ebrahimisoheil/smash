...
from smash_core.obsidian import import_obsidian_vault, render_import_obsidian_text  # noqa: E402


class ObsidianCoreTests(unittest.TestCase):
    def make_vault(self) -> Path:
        vault = Path(tempfile.mkdtemp(prefix="Smash-obsidian-vault-"))
    ...
    def test_import_obsidian_vault_copies_markdown_notes(self):
        target = Path(tempfile.mkdtemp(prefix="Smash-obsidian-target-"))
