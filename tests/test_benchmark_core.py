...
from smash_core.benchmark import (  # noqa: E402
    benchmark_health,
...
from smash_core.demo import create_demo_workspace  # noqa: E402


class BenchmarkCoreTests(unittest.TestCase):
    def test_build_benchmark_payload_times_demo_wiki(self):
        tmp = Path(tempfile.mkdtemp(prefix="Smash-benchmark-core-"))
        target = tmp / "demo"
    ...
    def test_benchmark_health_warns_on_slow_paths(self):
        ...
        self.assertIn("Run smash doctor --fix", health["recommendations"][0])
    ...
    def test_render_benchmark_text_includes_agent_safe_payloads_and_packet(self):
        ...
        self.assertIn("Smash benchmark: /tmp/Smash", text)
