...
from smash_core.memory import recall_memories  # noqa: E402
from smash_core.semantic import (  # noqa: E402
    SEMANTIC_MIN_COSINE,
...
class SemanticCoreTests(unittest.TestCase):
    ...
    def test_provider_override_requires_installed_package(self):
        import os
        from smash_core import semantic
    ...
    def test_externally_managed_guidance_never_prints_dead_pip_commands(self):
        ...
        self.assertIn(".smash-mcp-venv", joined)
...
class RerankTierTests(unittest.TestCase):
    ...
    def test_reranker_offline_guard_returns_none_without_model(self):
        from smash_core.semantic import load_reranker, rerank_disabled
...
class SemanticStatusCountTests(unittest.TestCase):
    def test_cli_semantic_counts_all_memories_not_only_active(self):
        ...
        link_py = Path(__file__).resolve().parents[1] / "smash.py"
