...
from smash_core.web_memory import (  # noqa: E402
...
class WebMemoryCoreTests(unittest.TestCase):
    def test_memory_card_escapes_content_and_renders_actions(self):
        record = {
            ...
            "actions": [{
                "label": "Review",
                "kind": "review",
                "command": "smash review-memory local-memory",
        ...
        self.assertIn('data-copy-text="smash review-memory local-memory"', html)
    ...
    def test_memory_section_uses_action_hints_when_record_has_no_actions(self):
        ...
        html = render_memory_section(
            ...
            action_hints=lambda _record: [{
                "label": "Archive",
                "kind": "archive",
                "command": "smash archive-memory agent-memory",
        ...
        self.assertIn("smash archive-memory agent-memory", html)
    ...
    def test_next_actions_render_commands(self):
        ...
        self.assertIn("smash memory-inbox", html)
        self.assertIn('data-copy-text="smash memory-inbox"', html)
