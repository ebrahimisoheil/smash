...
class WebGraphCoreTests(unittest.TestCase):
    ...
    def test_render_graph_empty_body(self):
        ...
        self.assertIn('data-copy-text="ingest the new raw Smash files"', html)
    ...
    def test_render_graph_page_body_includes_controls_and_escapes_note(self):
        ...
        self.assertIn('id="graph-copy-Smash"', html)
    ...
    def test_render_graph_script_uses_supplied_json_payloads(self):
        ...
        self.assertIn("var GRAPH_STORAGE_KEY = 'Smash.graph.controls.v1';", script)
        ...
        self.assertIn("var copyLinkButton = document.getElementById('graph-copy-Smash');", script)
