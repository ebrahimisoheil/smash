...
from smash_core.web_home import plural_type_label, render_home_page  # noqa: E402
...
def test_render_home_page_shows_stats_sections_and_prompts():
    ...
    prompts = {"prompts": [{"prompt": "is Smash ready?"}, {"prompt": "ingest raw/<file> into Smash"}]}
    ...
    assert "<title>Smash</title>" in html
    ...
    assert "ingest raw/&lt;file&gt; into Smash" in html
    assert 'data-copy-text="ingest raw/&lt;file&gt; into Smash"' in html
