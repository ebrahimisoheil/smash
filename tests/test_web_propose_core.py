...
from smash_core.web_propose import render_propose_page  # noqa: E402
...
def test_render_propose_page_shows_review_only_workflow():
    html = render_propose_page("Smash", "raw/first-memory.md", layout=_layout)
    ...
    assert 'data-copy-text="query Smash for what you remember about this task"' in html
