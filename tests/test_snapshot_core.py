...
from smash_core.snapshot import export_snapshot, render_snapshot_text  # noqa: E402
...
class SnapshotCoreTests(unittest.TestCase):
    def setUp(self):
        self.root = Path(tempfile.mkdtemp(prefix="Smash-snapshot-test-"))
    ...
    def test_export_snapshot_excludes_memories_and_raw_by_default(self):
        ...
        self.assertEqual(payload["schema"], "Smash-snapshot-v1")
