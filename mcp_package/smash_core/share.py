"""Local permalink helpers for Smash wiki pages."""
...
def share_page_payload(
    ...
    *,
    ...
    try:
        ...
        serve_command = ["smash", "serve", str(root), "--port", str(port)]
        return {
            "found": True,
            "query": query,
            ...
            "agent_prompt": f"open Smash page {page_name} and summarize why it matters",
            "candidates": candidates,
        }
    finally:
        if owns_cache:
