"""HTML helpers for Smash starter prompt pages."""
...
def render_prompts_page(payload: Mapping[str, object], *, layout: PageLayout) -> str:
    ...
    project_line = (
        ...
        else '<p class="summary">These prompts work for a personal Smash wiki. Add <code>?project=slug</code> for project wording.</p>'
    )
    ...
    body = (
        '<div class="breadcrumb"><a href="/">Smash</a> / prompts</div>'
