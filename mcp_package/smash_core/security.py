"""Local security hygiene helpers for Smash."""
...
def find_sensitive_filenames(
    ...
    *,
    ...
    """Find secret-looking filenames under a Smash root."""
...
def find_sensitive_values(
    ...
    *,
    ...
    """Find secret-looking file contents and read errors under a Smash root."""
    root = target.expanduser().resolve()
    matches: list[str] = []
