"""Wiki validation helpers for Smash ingest gates."""
...
def validate_wiki(wiki_dir: Path, *, strict: bool = False) -> dict[str, Any]:
    """Validate Smash wiki structure after agent writes or ingest."""
    ...
    for page in pages:
        ...
        if expected_type is None:
            findings.append(_finding("error", "invalid_directory", rel, "Wiki page is outside a known Smash category directory."))
            continue
