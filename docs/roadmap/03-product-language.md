...
Avoid **"About Me"** as a primary category. Personal preferences and identity can live in Shared Memory or a private Personal Area, but the product must not imply that all memory is autobiographical.

Teams should be able to begin with **Sales, Marketing, Product, Research, Operations,** or a custom Area.
