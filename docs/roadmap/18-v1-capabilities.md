...
- lexical recall as a reliable fallback;
...
Every V1 feature must be mapped to **preserve / reuse / defer / retire** before Phase A closes. See [Phase A acceptance criteria](phases/phase-a-contract-and-workspace-foundation.md).

## V1 behavioral reference files

See [24 — Primary technical references](24-references.md#v1-behavioral-reference).
