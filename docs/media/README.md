...
- `smash-aha.svg` (in `../assets/`) — the animated "aha" demo used on the
...
- `smash-aha.tape` — charmbracelet [vhs](https://github.com/charmbracelet/vhs)
  script that renders the README GIF (`../assets/smash-aha.gif`) from real `smash`
